...
Review.create!(content: "My stay with Astral Escapes was nothing short of extraordinary! From the moment I arrived on the shimmering surface of Castila, I was captivated by its otherworldly beauty. The accommodations were beyond compare, and the sense of wonder I experienced exploring the alien landscapes will stay with me forever. A truly unforgettable cosmic getaway!", rating: 5, booking_id: 1)
...
Review.create!(content: "My stay with Astral Escapes was utterly disappointing. The planet I booked, Eudoxia, turned out to be inhospitable and downright hostile. From scorching temperatures to toxic atmospheres, it was impossible to enjoy any aspect of the supposed 'getaway.' The accommodations were subpar at best, barely providing shelter from the relentless elements. Save yourself the trouble and steer clear of this disastrous destination. Astral Escapes, you've missed the mark by light-years with this one.", rating: 1, booking_id: 3)

Review.create!(content: "My stay with Astral Escapes exceeded all expectations! While the planet Navnan Ghar may have been unconventional, the culinary experience was out of this world. The local delicacies, including delicious alien bug dishes, were surprisingly delightful and truly a highlight of the trip. Despite initial hesitation, I found myself indulging in flavors I never thought possible. The accommodations were comfortable, and the staff went above and beyond to ensure a memorable stay. A truly stellar experience that I would highly recommend to any adventurous foodie!", rating: 5, booking_id: 4)
