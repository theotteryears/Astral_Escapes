...
Booking.create!(visitor_id: 1, planet_id: 38, start_date: Date.new(2022,05,12), end_date: Date.new(2022,05,19), status: "Unconfirmed")
Booking.create!(visitor_id: 1, planet_id: 31, start_date: Date.new(2022,05,12), end_date: Date.new(2022,05,19), status: "Unconfirmed")
Booking.create!(visitor_id: 1, planet_id: 7, start_date: Date.new(2022,05,12), end_date: Date.new(2022,05,17), status: "Confirmed")
